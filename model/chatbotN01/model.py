...
path_lines = "model/chatbotN01/cornell_movie_dialogs_corpus/cornell movie-dialogs corpus/movie_lines.txt"

path_movie_conversions = "model/chatbotN01/cornell_movie_dialogs_corpus/cornell movie-dialogs corpus/movie_conversations.txt"
...
class ChatbotN01(model):
    def __init__(self):
        ...
        self.model.load_weights("model/weights/model_tf.h5")
